...
@Autonomous(name = "Left Close", group = "Examples")
public class LeftClose extends OpMode {
    ...
    private final Pose scorePose = new Pose(60, 85, Math.toRadians(140)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose pickup1Pose = new Pose(18, 82, Math.toRadians(180)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(18, 57, Math.toRadians(180)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose openGat = new Pose(18,70, Math.toRadians(270));
    private final Pose pickup3Pose = new Pose(18, 36, Math.toRadians(180));
    private final Pose leaveLaunchPose = new Pose(60, 40, Math.toRadians(90));

    private Path scorePreload;
    private PathChain grabPickup1, scorePickup1, grabPickup2, scorePickup2, grabPickup3, scorePickup3, leaveLaunchZone;
    ...
    scorePreload.setConstantInterpolation(startPose.getHeading()); */
        ...
        grabPickup3 = follower.pathBuilder()
                .addPath(new BezierCurve(follower::getPose, new Pose(63,30), pickup3Pose))
                //.addParametricCallback(.3, intake::intakeAuto)
        ...
        leaveLaunchZone = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(scorePose.getHeading(), leaveLaunchPose.getHeading())
                .build();
    }
