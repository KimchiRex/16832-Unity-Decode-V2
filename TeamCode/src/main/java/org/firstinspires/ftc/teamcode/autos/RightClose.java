...
@Autonomous(name = "Right Close", group = "Examples")
public class RightClose extends OpMode {
    ...
    private final Pose startPose = new Pose(144-28.5, 128, Math.toRadians(0)); // Start Pose of our robot.
    private final Pose scorePose = new Pose(144-60, 85, Math.toRadians(43)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose pickup1Pose = new Pose(144-18, 82, Math.toRadians(0)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(144-22, 57, Math.toRadians(0)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose openGat = new Pose(144-18,70, Math.toRadians(0));
    private final Pose pickup3Pose = new Pose(144-22, 36, Math.toRadians(0));
    ...
    scorePreload.setConstantInterpolation(startPose.getHeading()); */
        ...
        grabPickup3 = follower.pathBuilder()
                .addPath(new BezierCurve(follower::getPose, new Pose(144-63,30), pickup3Pose))
                //.addParametricCallback(.3, intake::intakeAuto)
